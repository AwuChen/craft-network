...
links:[
  ...
  {source:"Awu Chen",target:"Taeko Hosoo"},
  {source:"Awu Chen",target:"Kondo"},
  {source:"Awu Chen",target:"Yui Kondo"},
  {source:"Awu Chen",target:"Kondo"},
  ...
  {source:"Awu Chen",target:"Yoshida Shinichiro"},
  {source:"Yoshida Shinichiro",target:"Mae Englegeer"},
  {source:"Awu Chen",target:"Mae Englegeer"},
  {source:"Awu Chen",target:"Mae Englegeer"},
  {source:"Awu Chen",target:"Mae Englegeer"},
  {source:"Mae Englegeer",target:"John Hijika"},
  {source:"Awu Chen",target:"Hosai Matsubayashi"},
  {source:"Awu Chen",target:"Toryo Ito"},
  {source:"Awu Chen",target:"Hidehiko Matsumoto"},
  {source:"Awu Chen",target:"Takafumi Zenryu Kawakami"},
  {source:"Awu Chen",target:"Ami Miura"},
  {source:"Awu Chen",target:"Mitsuru Yokoyama"},
  {source:"Awu Chen",target:"Ako Myochin"},
  {source:"Mitsuru Yokoyama",target:"Mae Englegeer"},
  {source:"Awu Chen",target:"Ko Kado"},
  {source:"Awu Chen",target:"A-C-K"},
  {source:"Sky Whitehead",target:"Awu Chen"},
  {source:"Tanabe Chikuunsai IV",target:"Sky Whitehead"},
  {source:"Awu Chen",target:"Yu Kamimura"},
  {source:"Awu Chen",target:"Yuna Yagi"},
  ...
  addNodeToAwuChen = () => {
    ...
    this.setState(prevState => {
      const updatedData = {
        nodes: [...prevState.data.nodes, { name: newNodeName, color: 'Gray', craft: 'New User' }],
